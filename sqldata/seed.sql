...
INSERT INTO `nagios_cgi_configuration` (`id`, `physical_html_path`, `url_html_path`, `use_authentication`, `default_user_name`, `authorized_for_system_information`, `authorized_for_system_commands`, `authorized_for_configuration_information`, `authorized_for_all_hosts`, `authorized_for_all_host_commands`, `authorized_for_all_services`, `authorized_for_all_service_commands`, `lock_author_names`, `statusmap_background_image`, `default_statusmap_layout`, `statuswrl_include`, `default_statuswrl_layout`, `refresh_rate`, `host_unreachable_sound`, `host_down_sound`, `service_critical_sound`, `service_warning_sound`, `service_unknown_sound`, `ping_syntax`, `escape_html_tags`, `notes_url_target`, `action_url_target`, `enable_splunk_integration`, `splunk_url`) VALUES (2,'/usr/local/nagios/share','/nagios',1,NULL,'nagiosadmin','nagiosadmin','nagiosadmin','nagiosadmin','nagiosadmin','nagiosadmin','nagiosadmin',NULL,NULL,5,NULL,4,90,NULL,NULL,NULL,NULL,NULL,'/bin/ping -n -U -c 5 $HOSTADDRESS$',NULL,NULL,NULL,NULL,NULL);
