...
(
	...
	`cmd` VARCHAR(255),
	PRIMARY KEY (`id`)
) ENGINE=MyISAM COMMENT='Import Job Information';
...
(
	...
	`cmd` VARCHAR(255),
	PRIMARY KEY (`id`)
) ENGINE=MyISAM COMMENT='Export Job Information';
...
(
	...
	CONSTRAINT `export_log_entry_FK_1`
		...
		ON DELETE CASCADE
) ENGINE=MyISAM COMMENT='Export Job Entry';
...
(
	...
	CONSTRAINT `import_log_entry_FK_1`
		...
		ON DELETE CASCADE
) ENGINE=MyISAM COMMENT='Import Job Entry';
...
(
	...
	`label` TEXT,
	PRIMARY KEY (`id`)
) ENGINE=MyISAM COMMENT='Language based labels';
...
(
	...
	PRIMARY KEY (`id`)
) ENGINE=MyISAM COMMENT='Event Broker Modules';
...
(
	...
	PRIMARY KEY (`id`)
) ENGINE=MyISAM COMMENT='Nagios Command';
...
(
	...
	PRIMARY KEY (`id`)
) ENGINE=MyISAM COMMENT='Nagios Timeperiods';
...
(
	...
	CONSTRAINT `nagios_timeperiod_entry_FK_1`
		...
		ON DELETE SET NULL
) ENGINE=MyISAM COMMENT='Time Period Entries';
...
(
	...
	CONSTRAINT `nagios_timeperiod_exclude_FK_2`
		...
		REFERENCES `nagios_timeperiod` (`id`)
		ON DELETE SET NULL
) ENGINE=MyISAM COMMENT='Time Period Excludes';
...
(
	...
	CONSTRAINT `nagios_contact_FK_2`
		...
		REFERENCES `nagios_timeperiod` (`id`)
		ON DELETE SET NULL
) ENGINE=MyISAM COMMENT='Nagios Contact';
...
(
	...
	CONSTRAINT `nagios_contact_address_FK_1`
		...
		ON DELETE CASCADE
) ENGINE=MyISAM COMMENT='Nagios Contact Address';
...
(
	...
	`alias` VARCHAR(255) NOT NULL,
	PRIMARY KEY (`id`)
) ENGINE=MyISAM COMMENT='Nagios Contact Group';
...
(
	...
	CONSTRAINT `nagios_contact_group_member_FK_2`
		...
		ON DELETE CASCADE
) ENGINE=MyISAM COMMENT='Member of a Nagios Contact Group';
...
(
	...
	CONSTRAINT `nagios_contact_notification_command_FK_2`
		...
		ON DELETE CASCADE
) ENGINE=MyISAM COMMENT='Notification Command for a Nagios Contact';
...
(
	...
	CONSTRAINT `nagios_host_template_FK_4`
		...
		REFERENCES `nagios_timeperiod` (`id`)
		ON DELETE SET NULL
) ENGINE=MyISAM COMMENT='Nagios Host Template';
...
(
	...
	CONSTRAINT `nagios_host_FK_4`
		...
		REFERENCES `nagios_timeperiod` (`id`)
		ON DELETE SET NULL
) ENGINE=MyISAM COMMENT='Nagios Host';
...
(
	...
	CONSTRAINT `nagios_service_template_FK_4`
		...
		REFERENCES `nagios_timeperiod` (`id`)
		ON DELETE SET NULL
) ENGINE=MyISAM COMMENT='Nagios Service Template';
...
(
	...
	CONSTRAINT `nagios_service_FK_7`
		...
		REFERENCES `nagios_timeperiod` (`id`)
		ON DELETE SET NULL
) ENGINE=MyISAM COMMENT='Nagios Service';
...
(
	...
	CONSTRAINT `nagios_service_check_command_parameter_FK_2`
		...
		ON DELETE CASCADE
) ENGINE=MyISAM COMMENT='Parameter for check command for service or service template';
...
(
	...
	`action_url` VARCHAR(255),
	PRIMARY KEY (`id`)
) ENGINE=MyISAM COMMENT='Nagios  Service Group';
...
(
	...
	CONSTRAINT `nagios_host_contact_member_FK_3`
		...
		REFERENCES `nagios_contact` (`id`)
		ON DELETE CASCADE
) ENGINE=MyISAM COMMENT='Contacts which belong to host templates or hosts';
...
(
	...
	CONSTRAINT `nagios_service_contact_member_FK_3`
		...
		REFERENCES `nagios_contact` (`id`)
		ON DELETE CASCADE
) ENGINE=MyISAM COMMENT='Contacts which belong to service templates or services';
...
(
	...
	CONSTRAINT `nagios_dependency_FK_6`
		...
		REFERENCES `nagios_timeperiod` (`id`)
		ON DELETE CASCADE
) ENGINE=MyISAM COMMENT='Nagios Dependency';
...
(
	...
	CONSTRAINT `nagios_dependency_target_FK_4`
		...
		REFERENCES `nagios_hostgroup` (`id`)
		ON DELETE CASCADE
) ENGINE=MyISAM COMMENT='Targets for a Dependency';
...
(
	...
	CONSTRAINT `nagios_escalation_FK_6`
		...
		REFERENCES `nagios_timeperiod` (`id`)
		ON DELETE SET NULL
) ENGINE=MyISAM COMMENT='Nagios Escalation';
...
(
	...
	CONSTRAINT `nagios_escalation_contact_FK_2`
		...
		REFERENCES `nagios_contact` (`id`)
		ON DELETE CASCADE
) ENGINE=MyISAM COMMENT='Contact Group for Escalation';
...
(
	...
	CONSTRAINT `nagios_host_contactgroup_FK_3`
		...
		REFERENCES `nagios_contact_group` (`id`)
		ON DELETE CASCADE
) ENGINE=MyISAM COMMENT='Contact Group for Host';
...
(
	...
	`action_url` VARCHAR(255),
	PRIMARY KEY (`id`)
) ENGINE=MyISAM COMMENT='Nagios Hostgroup';
...
(
	...
	CONSTRAINT `nagios_hostgroup_membership_FK_3`
		...
		REFERENCES `nagios_hostgroup` (`id`)
		ON DELETE CASCADE
) ENGINE=MyISAM COMMENT='Hostgroup Membership for Host';
...
(
	...
	CONSTRAINT `nagios_host_check_command_parameter_FK_2`
		...
		REFERENCES `nagios_host_template` (`id`)
		ON DELETE CASCADE
) ENGINE=MyISAM COMMENT='Parameter for Host Check Command';
...
(
	...
	CONSTRAINT `nagios_host_parent_FK_3`
		...
		REFERENCES `nagios_host_template` (`id`)
		ON DELETE CASCADE
) ENGINE=MyISAM COMMENT='Nagios Additional Host Parent Relationship';
...
(
	...
	`user32` VARCHAR(255),
	PRIMARY KEY (`id`)
) ENGINE=MyISAM COMMENT='Nagios Resource';
...
(
	...
	`check_for_updates` TINYINT,
	`check_for_orphaned_hosts` TINYINT,
	`bare_update_check` TINYINT,
	`log_current_states` TINYINT,
	`check_workers` INTEGER,
	`query_socket` VARCHAR(255),
	PRIMARY KEY (`id`),
	...
	CONSTRAINT `nagios_main_configuration_FK_8`
		...
		REFERENCES `nagios_command` (`id`)
		ON DELETE CASCADE
) ENGINE=MyISAM COMMENT='Nagios Main Configuration';
...
(
	...
	CONSTRAINT `nagios_host_template_inheritance_FK_3`
		...
		REFERENCES `nagios_host_template` (`id`)
		ON DELETE CASCADE
) ENGINE=MyISAM COMMENT='Nagios Host Template Inheritance';
...
(
	...
	CONSTRAINT `nagios_service_template_inheritance_FK_3`
		...
		REFERENCES `nagios_service_template` (`id`)
		ON DELETE CASCADE
) ENGINE=MyISAM COMMENT='Nagios service Template Inheritance';
...
(
	...
	`cmd` VARCHAR(255),
	PRIMARY KEY (`id`)
) ENGINE=MyISAM COMMENT='AutoDiscovery Job Information';
...
(
	...
	CONSTRAINT `autodiscovery_device_FK_3`
		...
		REFERENCES `nagios_host` (`id`)
		ON DELETE SET NULL
) ENGINE=MyISAM COMMENT='AutoDiscovery Found Device';
...
(
	...
	CONSTRAINT `autodiscovery_device_service_FK_1`
		...
		ON DELETE CASCADE
) ENGINE=MyISAM COMMENT='AutoDiscovery Found Service';
