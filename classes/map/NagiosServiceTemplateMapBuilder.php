...
/**
 * This class adds structure of 'nagios_service_template' table to 'lilac' DatabaseMap object.
 *
 *
 *
 ...
 * @package    .map
 */
class NagiosServiceTemplateMapBuilder implements MapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = '.map.NagiosServiceTemplateMapBuilder';
	...
	{
		$this->dbMap = Propel::getDatabaseMap(NagiosServiceTemplatePeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(NagiosServiceTemplatePeer::TABLE_NAME);
		$tMap->setPhpName('NagiosServiceTemplate');
		$tMap->setClassname('NagiosServiceTemplate');
...
} // NagiosServiceTemplateMapBuilder
