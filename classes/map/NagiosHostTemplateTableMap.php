...
/**
 * This class defines the structure of the 'nagios_host_template' table.
 *
 *
 *
 ...
 */
class NagiosHostTemplateTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = '.map.NagiosHostTemplateTableMap';
	...
	{
		// attributes
		$this->setName('nagios_host_template');
		$this->setPhpName('NagiosHostTemplate');
		$this->setClassname('NagiosHostTemplate');
		$this->setPackage('');
		...
		$this->addColumn('AUTODISCOVERY_ADDRESS_FILTER', 'AutodiscoveryAddressFilter', 'VARCHAR', false, 255, null);
		$this->addColumn('AUTODISCOVERY_HOSTNAME_FILTER', 'AutodiscoveryHostnameFilter', 'VARCHAR', false, 255, null);
		$this->addColumn('AUTODISCOVERY_OS_FAMILY_FILTER', 'AutodiscoveryOsFamilyFilter', 'VARCHAR', false, 255, null);
		$this->addColumn('AUTODISCOVERY_OS_GENERATION_FILTER', 'AutodiscoveryOsGenerationFilter', 'VARCHAR', false, 255, null);
		$this->addColumn('AUTODISCOVERY_OS_VENDOR_FILTER', 'AutodiscoveryOsVendorFilter', 'VARCHAR', false, 255, null);
		// validators
	} // initialize()
	...
	public function buildRelations()
	{
		...
		$this->addRelation('NagiosHostTemplateAutodiscoveryService', 'NagiosHostTemplateAutodiscoveryService', RelationMap::ONE_TO_MANY, array('id' => 'host_template', ), 'CASCADE', null);
		$this->addRelation('NagiosService', 'NagiosService', RelationMap::ONE_TO_MANY, array('id' => 'host_template', ), 'CASCADE', null);
		$this->addRelation('NagiosHostContactMember', 'NagiosHostContactMember', RelationMap::ONE_TO_MANY, array('id' => 'template', ), 'CASCADE', null);
		$this->addRelation('NagiosDependency', 'NagiosDependency', RelationMap::ONE_TO_MANY, array('id' => 'host_template', ), 'CASCADE', null);
		$this->addRelation('NagiosEscalation', 'NagiosEscalation', RelationMap::ONE_TO_MANY, array('id' => 'host_template', ), 'CASCADE', null);
		$this->addRelation('NagiosHostContactgroup', 'NagiosHostContactgroup', RelationMap::ONE_TO_MANY, array('id' => 'host_template', ), 'CASCADE', null);
		$this->addRelation('NagiosHostgroupMembership', 'NagiosHostgroupMembership', RelationMap::ONE_TO_MANY, array('id' => 'host_template', ), 'CASCADE', null);
		$this->addRelation('NagiosHostCheckCommandParameter', 'NagiosHostCheckCommandParameter', RelationMap::ONE_TO_MANY, array('id' => 'host_template', ), 'CASCADE', null);
		$this->addRelation('NagiosHostParent', 'NagiosHostParent', RelationMap::ONE_TO_MANY, array('id' => 'child_host_template', ), 'CASCADE', null);
		$this->addRelation('NagiosHostTemplateInheritanceRelatedBySourceTemplate', 'NagiosHostTemplateInheritance', RelationMap::ONE_TO_MANY, array('id' => 'source_template', ), 'CASCADE', null);
		$this->addRelation('NagiosHostTemplateInheritanceRelatedByTargetTemplate', 'NagiosHostTemplateInheritance', RelationMap::ONE_TO_MANY, array('id' => 'target_template', ), 'CASCADE', null);
		$this->addRelation('AutodiscoveryDevice', 'AutodiscoveryDevice', RelationMap::ONE_TO_MANY, array('id' => 'host_template', ), 'SET NULL', null);
		$this->addRelation('AutodiscoveryDeviceTemplateMatch', 'AutodiscoveryDeviceTemplateMatch', RelationMap::ONE_TO_MANY, array('id' => 'host_template', ), 'CASCADE', null);
		$this->addRelation('NagiosHostCustomObjectVar', 'NagiosHostCustomObjectVar', RelationMap::ONE_TO_MANY, array('id' => 'host_template', ), 'CASCADE', null);
	} // buildRelations()

} // NagiosHostTemplateTableMap
