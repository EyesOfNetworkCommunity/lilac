...
/**
 * This class adds structure of 'nagios_host' table to 'lilac' DatabaseMap object.
 *
 *
 *
 ...
 * @package    .map
 */
class NagiosHostMapBuilder implements MapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = '.map.NagiosHostMapBuilder';
	...
	{
		$this->dbMap = Propel::getDatabaseMap(NagiosHostPeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(NagiosHostPeer::TABLE_NAME);
		$tMap->setPhpName('NagiosHost');
		$tMap->setClassname('NagiosHost');
