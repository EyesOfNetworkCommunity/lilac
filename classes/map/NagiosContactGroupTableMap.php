...
/**
 * This class defines the structure of the 'nagios_contact_group' table.
 *
 *
 *
 ...
 */
class NagiosContactGroupTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = '.map.NagiosContactGroupTableMap';
	...
	{
		// attributes
		$this->setName('nagios_contact_group');
		$this->setPhpName('NagiosContactGroup');
		$this->setClassname('NagiosContactGroup');
		$this->setPackage('');
