...
/**
 * This class adds structure of 'autodiscovery_job' table to 'lilac' DatabaseMap object.
 *
 *
 *
 ...
 * @package    .map
 */
class AutodiscoveryJobMapBuilder implements MapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = '.map.AutodiscoveryJobMapBuilder';
	...
	{
		$this->dbMap = Propel::getDatabaseMap(AutodiscoveryJobPeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(AutodiscoveryJobPeer::TABLE_NAME);
		$tMap->setPhpName('AutodiscoveryJob');
		$tMap->setClassname('AutodiscoveryJob');
