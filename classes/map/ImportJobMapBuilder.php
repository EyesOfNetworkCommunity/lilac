...
/**
 * This class adds structure of 'import_job' table to 'lilac' DatabaseMap object.
 *
 *
 *
 ...
 * @package    .map
 */
class ImportJobMapBuilder implements MapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = '.map.ImportJobMapBuilder';
	...
	{
		$this->dbMap = Propel::getDatabaseMap(ImportJobPeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(ImportJobPeer::TABLE_NAME);
		$tMap->setPhpName('ImportJob');
		$tMap->setClassname('ImportJob');
