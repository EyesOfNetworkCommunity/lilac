...
class NagiosServiceTemplateTableMap extends TableMap
{
	...
	public function buildRelations()
	{
		...
		$this->addRelation('NagiosServiceCheckCommandParameter', 'NagiosServiceCheckCommandParameter', RelationMap::ONE_TO_MANY, array('id' => 'template', ), 'CASCADE', null);
		$this->addRelation('NagiosServiceGroupMember', 'NagiosServiceGroupMember', RelationMap::ONE_TO_MANY, array('id' => 'template', ), 'CASCADE', null);
		$this->addRelation('NagiosServiceContactMember', 'NagiosServiceContactMember', RelationMap::ONE_TO_MANY, array('id' => 'template', ), 'CASCADE', null);
		$this->addRelation('NagiosServiceContactGroupMember', 'NagiosServiceContactGroupMember', RelationMap::ONE_TO_MANY, array('id' => 'template', ), 'CASCADE', null);
		$this->addRelation('NagiosDependency', 'NagiosDependency', RelationMap::ONE_TO_MANY, array('id' => 'service_template', ), 'CASCADE', null);
