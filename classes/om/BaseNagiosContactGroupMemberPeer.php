...
/**
 * Base static class for performing query and update operations on the 'nagios_contact_group_member' table.
 *
 * Member of a Nagios Contact Group
 *
 * @package    propel.generator..om
 */
abstract class BaseNagiosContactGroupMemberPeer {

	/** the default database name for this class */
	const DATABASE_NAME = 'lilac';

	/** the table name for this class */
	const TABLE_NAME = 'nagios_contact_group_member';
	...
	const ID = 'nagios_contact_group_member.ID';

	/** the column name for the CONTACT field */
	const CONTACT = 'nagios_contact_group_member.CONTACT';

	/** the column name for the CONTACTGROUP field */
	const CONTACTGROUP = 'nagios_contact_group_member.CONTACTGROUP';
	 ...
	 * queries.
	 * @var        array NagiosContactGroupMember[]
	 */
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Contact', 'Contactgroup', ),
		...
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'CONTACT', 'CONTACTGROUP', ),
	...
	protected static $fieldKeys = array (
		...
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'CONTACT' => 1, 'CONTACTGROUP' => 2, ),
	...
	/**
	 * Method to invalidate the instance pool of all tables related to nagios_contact_group_member
	 ...
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 * @return     array (NagiosContactGroupMember object, last column rank)
	 */
	public static function populateObject($row, $startcol = 0)
	{
		$key = NagiosContactGroupMemberPeer::getPrimaryKeyHashFromRow($row, $startcol);
		if (null !== ($obj = NagiosContactGroupMemberPeer::getInstanceFromPool($key))) {
			// We no longer rehydrate the object, since this can cause data loss.
			// See http://www.propelorm.org/ticket/509
			// $obj->hydrate($row, $startcol, true); // rehydrate
			$col = $startcol + NagiosContactGroupMemberPeer::NUM_HYDRATE_COLUMNS;
		} else {
			$cls = NagiosContactGroupMemberPeer::OM_CLASS;
			$obj = new $cls();
	...
	public static function doCountJoinNagiosContact(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(NagiosContactGroupMemberPeer::CONTACT, NagiosContactPeer::ID, $join_behavior);
	...
	public static function doCountJoinNagiosContactGroup(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(NagiosContactGroupMemberPeer::CONTACTGROUP, NagiosContactGroupPeer::ID, $join_behavior);
	...
	public static function doSelectJoinNagiosContact(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		NagiosContactGroupMemberPeer::addSelectColumns($criteria);
		$startcol = NagiosContactGroupMemberPeer::NUM_HYDRATE_COLUMNS;
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		NagiosContactGroupMemberPeer::addSelectColumns($criteria);
		$startcol2 = NagiosContactGroupMemberPeer::NUM_HYDRATE_COLUMNS;
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseNagiosContactGroupMemberPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseNagiosContactGroupMemberPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new NagiosContactGroupMemberTableMap());
	  }
	}
	...
	/**
	 * Performs an INSERT on the database, given a NagiosContactGroupMember or Criteria object.
	 *
	...
	/**
	 * Performs an UPDATE on the database, given a NagiosContactGroupMember or Criteria object.
	 *
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(NagiosContactGroupMemberPeer::ID);
			if ($value) {
				$selectCriteria->add(NagiosContactGroupMemberPeer::ID, $value, $comparison);
			} else {
				$selectCriteria->setPrimaryTableName(NagiosContactGroupMemberPeer::TABLE_NAME);
			}
	...
	/**
	 * Deletes all rows from the nagios_contact_group_member table.
	 *
	 * @param      PropelPDO $con the connection to use
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll(PropelPDO $con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(NagiosContactGroupMemberPeer::TABLE_NAME, $con, NagiosContactGroupMemberPeer::DATABASE_NAME);
			// Because this db requires some delete cascade/set null emulation, we have to
			// clear the cached instance *after* the emulation has happened (since
			// instances get re-added by the select statement contained therein).
			NagiosContactGroupMemberPeer::clearInstancePool();
			NagiosContactGroupMemberPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Performs a DELETE on the database, given a NagiosContactGroupMember or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof NagiosContactGroupMember) { // it's a model object
...
//
BaseNagiosContactGroupMemberPeer::buildTableMap();
