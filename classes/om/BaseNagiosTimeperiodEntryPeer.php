...
abstract class BaseNagiosTimeperiodEntryPeer {
	...
	/** the column name for the TIMEPERIOD_ID field */
	const TIMEPERIOD_ID = 'nagios_timeperiod_entry.TIMEPERIOD_ID';

	/** the column name for the ENTRY field */
	const ENTRY = 'nagios_timeperiod_entry.ENTRY';
	 ...
	 * queries.
	 * @var        array NagiosTimeperiodEntry[]
	 */
