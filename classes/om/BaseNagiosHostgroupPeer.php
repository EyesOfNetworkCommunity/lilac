...
abstract class BaseNagiosHostgroupPeer {
	...
	const NAME = 'nagios_hostgroup.NAME';

	/** the column name for the ALIAS field */
	const ALIAS = 'nagios_hostgroup.ALIAS';

	/** the column name for the NOTES field */
	const NOTES = 'nagios_hostgroup.NOTES';

	/** the column name for the NOTES_URL field */
	const NOTES_URL = 'nagios_hostgroup.NOTES_URL';
