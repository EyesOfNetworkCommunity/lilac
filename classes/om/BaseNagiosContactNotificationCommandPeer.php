...
abstract class BaseNagiosContactNotificationCommandPeer {
	...
	const CONTACT_ID = 'nagios_contact_notification_command.CONTACT_ID';

	/** the column name for the COMMAND field */
	const COMMAND = 'nagios_contact_notification_command.COMMAND';
	 ...
	 * queries.
	 * @var        array NagiosContactNotificationCommand[]
	 */
