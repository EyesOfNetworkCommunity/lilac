...
// actual class may be a subclass -- as returned by ImportErrorPeer::getOMClass()
include_once 'ImportError.php';

/**
 * Base static class for performing query and update operations on the 'import_error' table.
 *
 * Import Job Errors
 *
 * @package    .om
 */
abstract class BaseImportErrorPeer {

	/** the default database name for this class */
	const DATABASE_NAME = 'lilac';

	/** the table name for this class */
	const TABLE_NAME = 'import_error';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'ImportError';
	...
	const ID = 'import_error.ID';

	/** the column name for the JOB field */
	const JOB = 'import_error.JOB';

	/** the column name for the TEXT field */
	const TEXT = 'import_error.TEXT';

	/** the column name for the TYPE field */
	const TYPE = 'import_error.TYPE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Job', 'Text', 'Type', ),
