...
/**
 * Base class that represents a row from the 'nagios_service_custom_object_var' table.
 *
 * Custom Object Variables for Service
 *
 * @package    propel.generator..om
 */
abstract class BaseNagiosServiceCustomObjectVar extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'NagiosServiceCustomObjectVarPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        NagiosServiceCustomObjectVarPeer
	 */
	 ...
	 * @return     NagiosServiceCustomObjectVar The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = NagiosServiceCustomObjectVarPeer::ID;
		}
	...
	public function setService($v)
	{
		...
		if ($this->service !== $v) {
			$this->service = $v;
			$this->modifiedColumns[] = NagiosServiceCustomObjectVarPeer::SERVICE;
		}
	...
	public function setServiceTemplate($v)
	{
		...
		if ($this->service_template !== $v) {
			...
			$this->modifiedColumns[] = NagiosServiceCustomObjectVarPeer::SERVICE_TEMPLATE;
		}
	...
	public function setVarName($v)
	{
		...
		if ($this->var_name !== $v) {
			$this->var_name = $v;
			$this->modifiedColumns[] = NagiosServiceCustomObjectVarPeer::VAR_NAME;
		}
	...
	public function setVarValue($v)
	{
		...
		if ($this->var_value !== $v) {
			$this->var_value = $v;
			$this->modifiedColumns[] = NagiosServiceCustomObjectVarPeer::VAR_VALUE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->service_template = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			...
			return $startcol + 5; // 5 = NagiosServiceCustomObjectVarPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating NagiosServiceCustomObjectVar object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = NagiosServiceCustomObjectVarPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				NagiosServiceCustomObjectVarQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				NagiosServiceCustomObjectVarPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(NagiosServiceCustomObjectVarPeer::ID) ) {
					...
					$affectedRows += NagiosServiceCustomObjectVarPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = NagiosServiceCustomObjectVarPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = NagiosServiceCustomObjectVarPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['NagiosServiceCustomObjectVar'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['NagiosServiceCustomObjectVar'][$this->getPrimaryKey()] = true;
		$keys = NagiosServiceCustomObjectVarPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getService(),
			$keys[2] => $this->getServiceTemplate(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setServiceTemplate($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NagiosServiceCustomObjectVarPeer::ID)) $criteria->add(NagiosServiceCustomObjectVarPeer::ID, $this->id);
		if ($this->isColumnModified(NagiosServiceCustomObjectVarPeer::SERVICE)) $criteria->add(NagiosServiceCustomObjectVarPeer::SERVICE, $this->service);
		if ($this->isColumnModified(NagiosServiceCustomObjectVarPeer::SERVICE_TEMPLATE)) $criteria->add(NagiosServiceCustomObjectVarPeer::SERVICE_TEMPLATE, $this->service_template);
		if ($this->isColumnModified(NagiosServiceCustomObjectVarPeer::VAR_NAME)) $criteria->add(NagiosServiceCustomObjectVarPeer::VAR_NAME, $this->var_name);
		if ($this->isColumnModified(NagiosServiceCustomObjectVarPeer::VAR_VALUE)) $criteria->add(NagiosServiceCustomObjectVarPeer::VAR_VALUE, $this->var_value);
	...
	{
		$criteria = new Criteria(NagiosServiceCustomObjectVarPeer::DATABASE_NAME);
		$criteria->add(NagiosServiceCustomObjectVarPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of NagiosServiceCustomObjectVar (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     NagiosServiceCustomObjectVar Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     NagiosServiceCustomObjectVarPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new NagiosServiceCustomObjectVarPeer();
		}
		return self::$peer;
	}
	...
	public function setNagiosService(NagiosService $v = null)
	{
		...
		if ($v !== null) {
			$v->addNagiosServiceCustomObjectVar($this);
		}
	...
	public function getNagiosService(PropelPDO $con = null)
	{
		if ($this->aNagiosService === null && ($this->service !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aNagiosService->addNagiosServiceCustomObjectVars($this);
			 */
		}
	...
	public function getNagiosServiceTemplate(PropelPDO $con = null)
	{
		if ($this->aNagiosServiceTemplate === null && ($this->service_template !== null)) {
			...
			/* The following can be used additionally to
				...
				undesirable since it could result in an only partially populated collection
				in the referenced object.
				$this->aNagiosServiceTemplate->addNagiosServiceCustomObjectVars($this);
			 */
		}
	...
	{
		return (string) $this->exportTo(NagiosServiceCustomObjectVarPeer::DEFAULT_STRING_FORMAT);
	}
...
} // BaseNagiosServiceCustomObjectVar
