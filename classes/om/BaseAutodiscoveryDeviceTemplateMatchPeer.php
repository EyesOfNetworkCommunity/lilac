...
abstract class BaseAutodiscoveryDeviceTemplateMatchPeer {
	...
	const DEVICE_ID = 'autodiscovery_device_template_match.DEVICE_ID';

	/** the column name for the HOST_TEMPLATE field */
	const HOST_TEMPLATE = 'autodiscovery_device_template_match.HOST_TEMPLATE';

	/** the column name for the PERCENT field */
	const PERCENT = 'autodiscovery_device_template_match.PERCENT';
	 ...
	 * queries.
	 * @var        array AutodiscoveryDeviceTemplateMatch[]
	 */
