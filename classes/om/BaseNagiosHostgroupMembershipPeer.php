...
/**
 * Base static class for performing query and update operations on the 'nagios_hostgroup_membership' table.
 *
 * Hostgroup Membership for Host
 *
 * @package    propel.generator..om
 */
abstract class BaseNagiosHostgroupMembershipPeer {

	/** the default database name for this class */
	const DATABASE_NAME = 'lilac';

	/** the table name for this class */
	const TABLE_NAME = 'nagios_hostgroup_membership';

	/** the related Propel class for this table */
	const OM_CLASS = 'NagiosHostgroupMembership';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'NagiosHostgroupMembership';

	/** the related TableMap class for this table */
	const TM_CLASS = 'NagiosHostgroupMembershipTableMap';
	...
	const ID = 'nagios_hostgroup_membership.ID';

	/** the column name for the HOST field */
	const HOST = 'nagios_hostgroup_membership.HOST';

	/** the column name for the HOST_TEMPLATE field */
	const HOST_TEMPLATE = 'nagios_hostgroup_membership.HOST_TEMPLATE';

	/** the column name for the HOSTGROUP field */
	const HOSTGROUP = 'nagios_hostgroup_membership.HOSTGROUP';

	/** The default string format for model objects of the related table **/
	const DEFAULT_STRING_FORMAT = 'YAML';
	
	/**
	 * An identiy map to hold any loaded instances of NagiosHostgroupMembership objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array NagiosHostgroupMembership[]
	 */
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Host', 'HostTemplate', 'Hostgroup', ),
		...
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'HOST', 'HOST_TEMPLATE', 'HOSTGROUP', ),
	...
	protected static $fieldKeys = array (
		...
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'HOST' => 1, 'HOST_TEMPLATE' => 2, 'HOSTGROUP' => 3, ),
	...
	/**
	 * Method to invalidate the instance pool of all tables related to nagios_hostgroup_membership
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = NagiosHostgroupMembershipPeer::getOMClass(false);
	 ...
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 * @return     array (NagiosHostgroupMembership object, last column rank)
	 */
	public static function populateObject($row, $startcol = 0)
	{
		$key = NagiosHostgroupMembershipPeer::getPrimaryKeyHashFromRow($row, $startcol);
		if (null !== ($obj = NagiosHostgroupMembershipPeer::getInstanceFromPool($key))) {
			// We no longer rehydrate the object, since this can cause data loss.
			// See http://www.propelorm.org/ticket/509
			// $obj->hydrate($row, $startcol, true); // rehydrate
			$col = $startcol + NagiosHostgroupMembershipPeer::NUM_HYDRATE_COLUMNS;
		} else {
			$cls = NagiosHostgroupMembershipPeer::OM_CLASS;
			$obj = new $cls();
	...
	public static function doCountJoinNagiosHost(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(NagiosHostgroupMembershipPeer::HOST, NagiosHostPeer::ID, $join_behavior);
	...
	public static function doCountJoinNagiosHostTemplate(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(NagiosHostgroupMembershipPeer::HOST_TEMPLATE, NagiosHostTemplatePeer::ID, $join_behavior);
	...
	public static function doCountJoinNagiosHostgroup(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(NagiosHostgroupMembershipPeer::HOSTGROUP, NagiosHostgroupPeer::ID, $join_behavior);
	...
	public static function doSelectJoinNagiosHost(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		NagiosHostgroupMembershipPeer::addSelectColumns($criteria);
		$startcol = NagiosHostgroupMembershipPeer::NUM_HYDRATE_COLUMNS;
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		NagiosHostgroupMembershipPeer::addSelectColumns($criteria);
		$startcol2 = NagiosHostgroupMembershipPeer::NUM_HYDRATE_COLUMNS;
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseNagiosHostgroupMembershipPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseNagiosHostgroupMembershipPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new NagiosHostgroupMembershipTableMap());
	  }
	}
	...
	{
		return $withPrefix ? NagiosHostgroupMembershipPeer::CLASS_DEFAULT : NagiosHostgroupMembershipPeer::OM_CLASS;
	}

	/**
	 * Performs an INSERT on the database, given a NagiosHostgroupMembership or Criteria object.
	 *
	...
	/**
	 * Performs an UPDATE on the database, given a NagiosHostgroupMembership or Criteria object.
	 *
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(NagiosHostgroupMembershipPeer::ID);
			if ($value) {
				$selectCriteria->add(NagiosHostgroupMembershipPeer::ID, $value, $comparison);
			} else {
				$selectCriteria->setPrimaryTableName(NagiosHostgroupMembershipPeer::TABLE_NAME);
			}
	...
	/**
	 * Deletes all rows from the nagios_hostgroup_membership table.
	 *
	 * @param      PropelPDO $con the connection to use
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll(PropelPDO $con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(NagiosHostgroupMembershipPeer::TABLE_NAME, $con, NagiosHostgroupMembershipPeer::DATABASE_NAME);
			// Because this db requires some delete cascade/set null emulation, we have to
			// clear the cached instance *after* the emulation has happened (since
			// instances get re-added by the select statement contained therein).
			NagiosHostgroupMembershipPeer::clearInstancePool();
			NagiosHostgroupMembershipPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Performs a DELETE on the database, given a NagiosHostgroupMembership or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof NagiosHostgroupMembership) { // it's a model object
...
//
BaseNagiosHostgroupMembershipPeer::buildTableMap();
