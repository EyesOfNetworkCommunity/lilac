...
/**
 * Base static class for performing query and update operations on the 'nagios_host_contactgroup' table.
 *
 * Contact Group for Host
 *
 * @package    propel.generator..om
 */
abstract class BaseNagiosHostContactgroupPeer {

	/** the default database name for this class */
	const DATABASE_NAME = 'lilac';

	/** the table name for this class */
	const TABLE_NAME = 'nagios_host_contactgroup';

	/** the related Propel class for this table */
	const OM_CLASS = 'NagiosHostContactgroup';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'NagiosHostContactgroup';

	/** the related TableMap class for this table */
	const TM_CLASS = 'NagiosHostContactgroupTableMap';
	...
	const ID = 'nagios_host_contactgroup.ID';

	/** the column name for the HOST field */
	const HOST = 'nagios_host_contactgroup.HOST';

	/** the column name for the HOST_TEMPLATE field */
	const HOST_TEMPLATE = 'nagios_host_contactgroup.HOST_TEMPLATE';

	/** the column name for the CONTACTGROUP field */
	const CONTACTGROUP = 'nagios_host_contactgroup.CONTACTGROUP';

	/** The default string format for model objects of the related table **/
	const DEFAULT_STRING_FORMAT = 'YAML';
	
	/**
	 * An identiy map to hold any loaded instances of NagiosHostContactgroup objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array NagiosHostContactgroup[]
	 */
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Host', 'HostTemplate', 'Contactgroup', ),
		...
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'HOST', 'HOST_TEMPLATE', 'CONTACTGROUP', ),
	...
	protected static $fieldKeys = array (
		...
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'HOST' => 1, 'HOST_TEMPLATE' => 2, 'CONTACTGROUP' => 3, ),
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn($alias . '.CONTACTGROUP');
		}
	}
	...
	/**
	 * Method to invalidate the instance pool of all tables related to nagios_host_contactgroup
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = NagiosHostContactgroupPeer::getOMClass(false);
	 ...
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 * @return     array (NagiosHostContactgroup object, last column rank)
	 */
	public static function populateObject($row, $startcol = 0)
	{
		$key = NagiosHostContactgroupPeer::getPrimaryKeyHashFromRow($row, $startcol);
		if (null !== ($obj = NagiosHostContactgroupPeer::getInstanceFromPool($key))) {
			// We no longer rehydrate the object, since this can cause data loss.
			// See http://www.propelorm.org/ticket/509
			// $obj->hydrate($row, $startcol, true); // rehydrate
			$col = $startcol + NagiosHostContactgroupPeer::NUM_HYDRATE_COLUMNS;
		} else {
			$cls = NagiosHostContactgroupPeer::OM_CLASS;
			$obj = new $cls();
	...
	public static function doCountJoinNagiosHost(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(NagiosHostContactgroupPeer::HOST, NagiosHostPeer::ID, $join_behavior);
	...
	public static function doCountJoinNagiosHostTemplate(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(NagiosHostContactgroupPeer::HOST_TEMPLATE, NagiosHostTemplatePeer::ID, $join_behavior);
	...
	public static function doCountJoinNagiosContactGroup(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(NagiosHostContactgroupPeer::CONTACTGROUP, NagiosContactGroupPeer::ID, $join_behavior);
	...
	public static function doSelectJoinNagiosHost(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		NagiosHostContactgroupPeer::addSelectColumns($criteria);
		$startcol = NagiosHostContactgroupPeer::NUM_HYDRATE_COLUMNS;
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		NagiosHostContactgroupPeer::addSelectColumns($criteria);
		$startcol2 = NagiosHostContactgroupPeer::NUM_HYDRATE_COLUMNS;
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseNagiosHostContactgroupPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseNagiosHostContactgroupPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new NagiosHostContactgroupTableMap());
	  }
	}
	...
	{
		return $withPrefix ? NagiosHostContactgroupPeer::CLASS_DEFAULT : NagiosHostContactgroupPeer::OM_CLASS;
	}

	/**
	 * Performs an INSERT on the database, given a NagiosHostContactgroup or Criteria object.
	 *
	...
	/**
	 * Performs an UPDATE on the database, given a NagiosHostContactgroup or Criteria object.
	 *
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(NagiosHostContactgroupPeer::ID);
			if ($value) {
				$selectCriteria->add(NagiosHostContactgroupPeer::ID, $value, $comparison);
			} else {
				$selectCriteria->setPrimaryTableName(NagiosHostContactgroupPeer::TABLE_NAME);
			}
	...
	/**
	 * Deletes all rows from the nagios_host_contactgroup table.
	 *
	 * @param      PropelPDO $con the connection to use
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll(PropelPDO $con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(NagiosHostContactgroupPeer::TABLE_NAME, $con, NagiosHostContactgroupPeer::DATABASE_NAME);
			// Because this db requires some delete cascade/set null emulation, we have to
			// clear the cached instance *after* the emulation has happened (since
			// instances get re-added by the select statement contained therein).
			NagiosHostContactgroupPeer::clearInstancePool();
			NagiosHostContactgroupPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Performs a DELETE on the database, given a NagiosHostContactgroup or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof NagiosHostContactgroup) { // it's a model object
...
//
BaseNagiosHostContactgroupPeer::buildTableMap();
