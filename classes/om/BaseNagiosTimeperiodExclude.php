...
abstract class BaseNagiosTimeperiodExclude extends BaseObject  implements Persistent {
	 ...
	 * @var        NagiosTimeperiodExcludePeer
	 */
	...
	/**
	 * The value for the excluded_timeperiod field.
	 * @var        int
	 */
	protected $excluded_timeperiod;

	/**
	 * @var        NagiosTimeperiod
	 */
	protected $aNagiosTimeperiodRelatedByTimeperiodId;

	/**
	 * @var        NagiosTimeperiod
	 */
	protected $aNagiosTimeperiodRelatedByExcludedTimeperiod;
