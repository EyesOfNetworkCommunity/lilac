...
/**
 * Base class that represents a row from the 'nagios_escalation_contact' table.
 *
 * Contact Group for Escalation
 *
 * @package    propel.generator..om
 */
abstract class BaseNagiosEscalationContact extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'NagiosEscalationContactPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        NagiosEscalationContactPeer
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = NagiosEscalationContactPeer::NUM_HYDRATE_COLUMNS.
	...
	{
		if (isset($alreadyDumpedObjects['NagiosEscalationContact'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['NagiosEscalationContact'][$this->getPrimaryKey()] = true;
