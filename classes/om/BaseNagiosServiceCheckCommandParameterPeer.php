...
abstract class BaseNagiosServiceCheckCommandParameterPeer {
	...
	const SERVICE = 'nagios_service_check_command_parameter.SERVICE';

	/** the column name for the TEMPLATE field */
	const TEMPLATE = 'nagios_service_check_command_parameter.TEMPLATE';
	 ...
	 * queries.
	 * @var        array NagiosServiceCheckCommandParameter[]
	 */
