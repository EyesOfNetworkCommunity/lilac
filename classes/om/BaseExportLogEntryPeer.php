...
/**
 * Base static class for performing query and update operations on the 'export_log_entry' table.
 *
 * Export Job Entry
 *
 * @package    propel.generator..om
 */
abstract class BaseExportLogEntryPeer {

	/** the default database name for this class */
	const DATABASE_NAME = 'lilac';

	/** the table name for this class */
	const TABLE_NAME = 'export_log_entry';

	/** the related Propel class for this table */
	const OM_CLASS = 'ExportLogEntry';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'ExportLogEntry';

	/** the related TableMap class for this table */
	const TM_CLASS = 'ExportLogEntryTableMap';
	...
	const ID = 'export_log_entry.ID';

	/** the column name for the JOB field */
	const JOB = 'export_log_entry.JOB';

	/** the column name for the TIME field */
	const TIME = 'export_log_entry.TIME';

	/** the column name for the TEXT field */
	const TEXT = 'export_log_entry.TEXT';

	/** the column name for the TYPE field */
	const TYPE = 'export_log_entry.TYPE';

	/** The default string format for model objects of the related table **/
	const DEFAULT_STRING_FORMAT = 'YAML';
	
	/**
	 * An identiy map to hold any loaded instances of ExportLogEntry objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array ExportLogEntry[]
	 */
	...
	/**
	 * Method to invalidate the instance pool of all tables related to export_log_entry
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = ExportLogEntryPeer::getOMClass(false);
	 ...
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 * @return     array (ExportLogEntry object, last column rank)
	 */
	public static function populateObject($row, $startcol = 0)
	{
		$key = ExportLogEntryPeer::getPrimaryKeyHashFromRow($row, $startcol);
		if (null !== ($obj = ExportLogEntryPeer::getInstanceFromPool($key))) {
			// We no longer rehydrate the object, since this can cause data loss.
			// See http://www.propelorm.org/ticket/509
			// $obj->hydrate($row, $startcol, true); // rehydrate
			$col = $startcol + ExportLogEntryPeer::NUM_HYDRATE_COLUMNS;
		} else {
			$cls = ExportLogEntryPeer::OM_CLASS;
			$obj = new $cls();
	...
	public static function doCountJoinExportJob(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ExportLogEntryPeer::JOB, ExportJobPeer::ID, $join_behavior);
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinExportJob(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		ExportLogEntryPeer::addSelectColumns($criteria);
		$startcol = ExportLogEntryPeer::NUM_HYDRATE_COLUMNS;
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		ExportLogEntryPeer::addSelectColumns($criteria);
		$startcol2 = ExportLogEntryPeer::NUM_HYDRATE_COLUMNS;

		ExportJobPeer::addSelectColumns($criteria);
		$startcol3 = $startcol2 + ExportJobPeer::NUM_HYDRATE_COLUMNS;
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseExportLogEntryPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseExportLogEntryPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new ExportLogEntryTableMap());
	  }
	}
	...
	{
		return $withPrefix ? ExportLogEntryPeer::CLASS_DEFAULT : ExportLogEntryPeer::OM_CLASS;
	}

	/**
	 * Performs an INSERT on the database, given a ExportLogEntry or Criteria object.
	 *
	...
	/**
	 * Performs an UPDATE on the database, given a ExportLogEntry or Criteria object.
	 *
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(ExportLogEntryPeer::ID);
			if ($value) {
				$selectCriteria->add(ExportLogEntryPeer::ID, $value, $comparison);
			} else {
				$selectCriteria->setPrimaryTableName(ExportLogEntryPeer::TABLE_NAME);
			}
	...
	/**
	 * Deletes all rows from the export_log_entry table.
	 *
	 * @param      PropelPDO $con the connection to use
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll(PropelPDO $con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(ExportLogEntryPeer::TABLE_NAME, $con, ExportLogEntryPeer::DATABASE_NAME);
			// Because this db requires some delete cascade/set null emulation, we have to
			// clear the cached instance *after* the emulation has happened (since
			// instances get re-added by the select statement contained therein).
			ExportLogEntryPeer::clearInstancePool();
			ExportLogEntryPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Performs a DELETE on the database, given a ExportLogEntry or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof ExportLogEntry) { // it's a model object
...
//
BaseExportLogEntryPeer::buildTableMap();
