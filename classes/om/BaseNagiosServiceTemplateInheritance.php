...
/**
 * Base class that represents a row from the 'nagios_service_template_inheritance' table.
 *
 * Nagios service Template Inheritance
 *
 * @package    propel.generator..om
 */
abstract class BaseNagiosServiceTemplateInheritance extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'NagiosServiceTemplateInheritancePeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        NagiosServiceTemplateInheritancePeer
	 */
	...
	/**
	 * The value for the source_service field.
	 * @var        int
	 */
	 ...
	 */
	protected $aNagiosServiceTemplateRelatedBySourceTemplate;

	/**
	 * @var        NagiosServiceTemplate
	 */
	protected $aNagiosServiceTemplateRelatedByTargetTemplate;
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = NagiosServiceTemplateInheritancePeer::NUM_HYDRATE_COLUMNS.
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				NagiosServiceTemplateInheritanceQuery::create()
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(NagiosServiceTemplateInheritancePeer::ID) ) {
	...
	{
		if (isset($alreadyDumpedObjects['NagiosServiceTemplateInheritance'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['NagiosServiceTemplateInheritance'][$this->getPrimaryKey()] = true;
		...
		if ($includeForeignObjects) {
			...
			if (null !== $this->aNagiosServiceTemplateRelatedBySourceTemplate) {
				$result['NagiosServiceTemplateRelatedBySourceTemplate'] = $this->aNagiosServiceTemplateRelatedBySourceTemplate->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
			}
			if (null !== $this->aNagiosServiceTemplateRelatedByTargetTemplate) {
				$result['NagiosServiceTemplateRelatedByTargetTemplate'] = $this->aNagiosServiceTemplateRelatedByTargetTemplate->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
			}
		}
		return $result;
	}
	...
	{
		$copyObj->setSourceService($this->getSourceService());
	...
	public function getNagiosService(PropelPDO $con = null)
	{
		if ($this->aNagiosService === null && ($this->source_service !== null)) {
			$this->aNagiosService = NagiosServiceQuery::create()->findPk($this->source_service, $con);
	...
	public function getNagiosServiceTemplateRelatedBySourceTemplate(PropelPDO $con = null)
	{
		if ($this->aNagiosServiceTemplateRelatedBySourceTemplate === null && ($this->source_template !== null)) {
			$this->aNagiosServiceTemplateRelatedBySourceTemplate = NagiosServiceTemplateQuery::create()->findPk($this->source_template, $con);
			/* The following can be used additionally to
				guarantee the related object contains a reference
				to this object.  This level of coupling may, however, be
				undesirable since it could result in an only partially populated collection
	...
	public function getNagiosServiceTemplateRelatedByTargetTemplate(PropelPDO $con = null)
	{
		if ($this->aNagiosServiceTemplateRelatedByTargetTemplate === null && ($this->target_template !== null)) {
			$this->aNagiosServiceTemplateRelatedByTargetTemplate = NagiosServiceTemplateQuery::create()->findPk($this->target_template, $con);
			/* The following can be used additionally to
				guarantee the related object contains a reference
				to this object.  This level of coupling may, however, be
				undesirable since it could result in an only partially populated collection
	...
	{
		return (string) $this->exportTo(NagiosServiceTemplateInheritancePeer::DEFAULT_STRING_FORMAT);
	}
