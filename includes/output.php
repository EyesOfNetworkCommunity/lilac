...
function print_header($title = null) {
	...
	if(self == top)
	{
		$("#navigation").html('<ul><li><a href="index.php">General</a></li><li><a href="templates.php">Templates</a></li><li><a href="hosts.php">Network</a></li><li><a href="importer.php">Imports</a></li><li><a href="tools.php">Tools</a></li><li><a href="about.php">About</a></li></ul><br><br>');
	}
	</script>
	<div id="main">
	<?php
